    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA BOOKING SERVICE</h3>
                    </div>
        ...
        <div class="box-body">
            ...
            <div style="padding-bottom: 10px;">
                ...
                <form method="get" action="<?= site_url('tbl_transaksi/word') ?>" target="_blank">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center" width="200px">
                        <?php 
                        echo anchor(site_url('tbl_transaksi/read/'.$tbl_transaksi->id_transaksi),'<i class="fa fa-print" aria-hidden="true"></i>','class="btn btn-danger btn-sm" target="_blank"'); 
                        echo '  '; 
